...
public class TypeCheckVisitor implements ASTVisitor {
	...
	public Object visitBinaryChain(BinaryChain binaryChain, Object arg) throws Exception {
		...
		case ARROW:
			...
			case IMAGE:
				...
				break;
			default:
				throw new TypeCheckException("Incorrect type " + chainType.toString() + " of chain before \"" + operator.getText() + " " + chainElemFirstToken.getText() + "\" at " + chain.getFirstToken().getPositionText() + ". Expect one of following: URL, FILE, FRAME, IMAGE.");	
			}
			break;
		case BARARROW:
			if (chainType == IMAGE) {
	...
	public Object visitFrameOpChain(FrameOpChain frameOpChain, Object arg) throws Exception {
		...
		tuple.visit(this, arg);		
		operator = frameOpChain.getFirstToken();
		switch (operator.kind) {
		case KW_SHOW:
		case KW_HIDE:
			legalTupleSize = 0;
	...
	public Object visitImageOpChain(ImageOpChain imageOpChain, Object arg) throws Exception {
		...
		tuple.visit(this, arg);		
		operator = imageOpChain.getFirstToken();
		switch (operator.kind) {
		case OP_WIDTH:
		case OP_HEIGHT:
			legalTupleSize = 0;
